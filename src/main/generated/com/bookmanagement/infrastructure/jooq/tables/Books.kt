...
import com.bookmanagement.infrastructure.jooq.keys.BOOKS_PKEY
import com.bookmanagement.infrastructure.jooq.keys.BOOK_AUTHORS__BOOK_AUTHORS_BOOK_ID_FKEY
...
open class Books(
     ...
     */
    val PUBLISH_STATUS: TableField<BooksRecord, String?> = createField(DSL.name("publish_status"), SQLDataType.VARCHAR(20).nullable(false).defaultValue(DSL.field(DSL.raw("'UNPUBLISHED'::character varying"), SQLDataType.VARCHAR)), this, "")
